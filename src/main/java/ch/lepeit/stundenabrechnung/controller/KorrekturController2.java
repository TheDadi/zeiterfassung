...
//@Named
//@SessionScoped
//public class KorrekturController2 extends Observable implements Serializable {
...
//		System.out.println(buchungen.getRowCount() + "Dario");
//
...
//		System.out.println(selection.size() + "haha");
//		return selection;
//	}
//
//	@PostConstruct
